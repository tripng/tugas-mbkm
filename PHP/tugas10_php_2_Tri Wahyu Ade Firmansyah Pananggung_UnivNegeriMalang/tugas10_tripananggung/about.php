    ...
    <div class="col-lg-4">
        <div class="card profile-card-2">
            <div class="card-img-block">
                <img class="img-fluid" src="assets/images/bgprofil.jpg" alt="Card image cap">
            </div>
            <div class="card-body pt-5">
                <img src="assets/images/mendingRambling.jpeg" alt="profile-image" class="profile">
                <h5 class="card-title">Tri Wahyu Ade Firmansyah Pananggung</h5>
                <p class="card-text">Saya adalah seorang mahasiswa di Universitas Negeri Malang jurusan Teknik
                    Informatika. saya memiliki ketertarikan pada web development, game development, dan designer.</p>
            ...
            <div class="card-body border-top border-light">
                <div class="media align-items-center">
                    ...
                    <div class="media-body text-left ml-3">
                        <div class="progress-wrapper">
                            <p>HTML5 <span class="float-right">95%</span></p>
                ...
                <div class="media align-items-center">
                    ...
                    <div class="media-body text-left ml-3">
                        <div class="progress-wrapper">
                            <p>Bootstrap 5 <span class="float-right">80%</span></p>
                            <div class="progress" style="height: 5px;">
                ...
                <div class="media align-items-center">
                    ...
                    <div class="media-body text-left ml-3">
                        <div class="progress-wrapper">
                            <p>AngularJS <span class="float-right">78%</span></p>
                            <div class="progress" style="height: 5px;">
                ...
                <hr>
                <div class="media align-items-center">
                    <div><img src="assets/images/timeline/react.svg" class="skill-img" alt="skill img">
                    </div>
                    <div class="media-body text-left ml-3">
                        <div class="progress-wrapper">
                            <p>React JS <span class="float-right">70%</span></p>
                            <div class="progress" style="height: 5px;">
