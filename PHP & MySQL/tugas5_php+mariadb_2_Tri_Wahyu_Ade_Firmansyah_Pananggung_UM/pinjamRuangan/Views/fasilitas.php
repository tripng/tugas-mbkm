        ...
        <div class="container">
            <div class="row heading">
                <div class="col-lg-12">
                    <h2>Fasilitas</h2>
                    <hr class="line02">
                    <div class="intro">Berikut Fasilitas-Fasilitas Yang Tersedia</div>
                </div>
            </div>
            <div class="row">
                <?php 
                foreach($fasilitas->getAll() as $key => $statemant) : 
                ?>
                <div class="post" style="background: #fff;">
                    <div class="col-lg-6 fix-right" style="padding: 0;">
                        <div class="art-header">
                            <img src="images/fasilitas-<?= ++$key ?>.jpg" />
                        </div>
                    </div>
                    <div class=" col-lg-6">
                        <form method="POST" action="Controllers/fasilitasController.php">
                            <div class="t-center" style="padding: 70px 0;">
                                <h3><?= $statemant['nama'] ?></h3>
                                <p><?= $statemant['keterangan'] ?></p>
                                <a class="btn btn-skin" href="?hal=fasilitas_detil&id=<?= $statemant['id'] ?>">Detil</a>
                                <a class="btn btn-skin" style="background: #f1c40f;"
                                    href="?hal=edit_fasilitas&id=<?= $statemant['id'] ?>">Edit</a>
                                <button name="hapusFasilitas" class="btn btn-skin" style="background: red"
