        ...
        <div class="container">
            <div class="row heading">
                <div class="col-lg-12">
                    <h2>Kategori</h2>
                    <hr class="line02">
                    <div class="intro">Berikut Kategori-Kategori Ruangan Yang Tersedia</div>
                </div>
            </div>
            <div class="row">
                <?php 
                foreach($kategori->getAll() as $key => $statemant) : 
                ?>
                <div class="post" style="background: #fff;">
                    <div class="col-lg-6 fix-right" style="padding: 0;">
                        <div class="art-header">
                            <img src="images/<?= $key+5 ?>-thumb.jpg" />
                        </div>
                    </div>
                    <div class=" col-lg-6">
                        <div class="t-center" style="padding: 70px 0;">
                            ...
                            <a class="btn btn-skin" style="background: #f1c40f;"
                                href="?hal=edit_kr&id=<?= $statemant['id'] ?>">Edit</a>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
