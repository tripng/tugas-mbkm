        ...
        <div class="container">
            <div class="row heading">
                <div class="col-lg-12">
                    ...
                    <hr class="line02">
                    <div class="intro">Berikut Ruangan Yang Tersedia</div>
                </div>
            </div>
            <div class="row">
                <?php 
                ...
                <div class="post" style="background: #fff;">
                    ...
                    <div class="kategori bg-info" style="padding:5px;width:20%;">
                        <?= $kategoriRuangan->getById($key+1)['nama'] ?></div>
                    <div class=" col-lg-6">
                        <div class="t-center" style="padding: 70px 0;">
                            <h3><?= $statemant['nama'] ?></h3>
                            <p><?= $statemant['alamat'] ?></p>
                            <p>Fasilitas <?= $fasilitas->getById($key+1)['nama'] ?> Dapat Digunakan
                                <?= $fasilitas->getById($key+1)['keterangan'] ?></p>
